...
public class FXMLController {
    ...
    //	System.out.println("OK");
    	//queste sono le righe di acquisizione dei dati e controllo
    	
    	String nome=txtNome.getText();
    	if(nome.length()==0) { //trovo un errore di input, lo segnalo e termina l'esecuzione
    	...
    	//queste sono le righe di handleOK
    	String saluto;
    	if(eta<18) {
    		saluto="Ciao, "+ nome+ "!";
    	}
